...
@string.literal.acBZefueOh = global [21 x i8] c"this shouldn't print\00"
@"%s " = global [4 x i8] c"%s \00"
@string.literal.TLNmwvUdgM = global [30 x i8] c"this should not print as well\00"
@string.literal.sOeYQXfTPM = global [25 x i8] c"this shouldnt print!!!!!\00"
...
main:
	...
	%4 = load i32, i32* %0
	%5 = icmp eq i32 %3, %4
	br i1 %5, label %if.then.hDgHIKLUPw, label %if.else.fUKMwLfyqV
...
if.then.hDgHIKLUPw:
	...
	br label %lastLeave.vTVvFfjPpE

if.else.fUKMwLfyqV:
	br label %lastLeave.vTVvFfjPpE

lastLeave.vTVvFfjPpE:
	%12 = alloca i32
	store i32 3, i32* %12
	%13 = alloca i32*
	store i32* %12, i32** %13
	...
	%17 = load i32, i32* %16
	%18 = icmp ne i32 %17, 3
	br i1 %18, label %if.then.UuPDJWRhin, label %if.else.DHqjHwbkQs

if.then.UuPDJWRhin:
	%19 = getelementptr [21 x i8], [21 x i8]* @string.literal.acBZefueOh, i32 0, i32 0
	%20 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%21 = call i32 (i8*, ...) @printf(i8* %20, i8* %19)
	br label %lastLeave.QiOtBTzbuV

if.else.DHqjHwbkQs:
	br label %lastLeave.QiOtBTzbuV

lastLeave.QiOtBTzbuV:
	%22 = alloca %aStruct-
	...
	br i1 %35, label %if.then.JTvcjrVKko, label %if.else.bufJnyWlDl

if.then.JTvcjrVKko:
	%36 = getelementptr [30 x i8], [30 x i8]* @string.literal.TLNmwvUdgM, i32 0, i32 0
	%37 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%38 = call i32 (i8*, ...) @printf(i8* %37, i8* %36)
	br label %lastLeave.NUhLzxVpil

if.else.bufJnyWlDl:
	br label %lastLeave.NUhLzxVpil

lastLeave.NUhLzxVpil:
	%39 = load i32*, i32** %29
	...
	br i1 %47, label %if.then.SOdKDkwFAk, label %if.else.ieutldhGAI

if.then.SOdKDkwFAk:
	%48 = getelementptr [25 x i8], [25 x i8]* @string.literal.sOeYQXfTPM, i32 0, i32 0
	%49 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%50 = call i32 (i8*, ...) @printf(i8* %49, i8* %48)
	br label %lastLeave.QeKAbDZUxX

if.else.ieutldhGAI:
	br label %lastLeave.QeKAbDZUxX

lastLeave.QeKAbDZUxX:
	ret void
}
