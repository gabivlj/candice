...
@string.literal.NTWYUFnWSk = global [21 x i8] c"this shouldn't print\00"
@"%s " = global [4 x i8] c"%s \00"
@string.literal.rNdSjCiCtd = global [30 x i8] c"this should not print as well\00"
@string.literal.hAEHYhTtmH = global [25 x i8] c"this shouldnt print!!!!!\00"
...
_main:
	...
	%4 = load i32, i32* %0
	%5 = icmp eq i32 %3, %4
	br i1 %5, label %if.then.kHgwUaZUIj, label %if.else.cgGxGqfzvV
...
leave.tTDDdhhTII:
	...
	%17 = load i32, i32* %16
	%18 = icmp ne i32 %17, 3
	br i1 %18, label %if.then.lwSStQuXFo, label %if.else.XmmGwYSUVv

if.then.lwSStQuXFo:
	%19 = getelementptr [21 x i8], [21 x i8]* @string.literal.NTWYUFnWSk, i32 0, i32 0
	%20 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%21 = call i32 (i8*, ...) @printf(i8* %20, i8* %19)
	br label %leave.yGDpKnvqmx
...
leave.yGDpKnvqmx:
	...
	br i1 %33, label %if.then.OphMbPpdBB, label %if.else.xJHnLKIRCM

if.then.OphMbPpdBB:
	%34 = getelementptr [30 x i8], [30 x i8]* @string.literal.rNdSjCiCtd, i32 0, i32 0
	%35 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%36 = call i32 (i8*, ...) @printf(i8* %35, i8* %34)
	br label %leave.wcNpjPCiWD
...
leave.wcNpjPCiWD:
	...
	br i1 %45, label %if.then.tJWoyaZWzb, label %if.else.tzDObibshu

if.then.tJWoyaZWzb:
	%46 = getelementptr [25 x i8], [25 x i8]* @string.literal.hAEHYhTtmH, i32 0, i32 0
	%47 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%48 = call i32 (i8*, ...) @printf(i8* %47, i8* %46)
	br label %leave.iguUDuPAUy
