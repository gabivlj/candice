...
@string.literal.JaNBvOiUcl = global [8 x i8] c"./aFile\00"
@string.literal.FQyaAJTWgh = global [3 x i8] c"a+\00"
@"%s " = global [4 x i8] c"%s \00"
@string.literal.QGSJUuIsxu = global [7 x i8] c"hello!\00"
@string.literal.UVDgPnWDIg = global [17 x i8] c"Hello candice!\5Cn\00"
...
doStuff:
	...
	%7 = getelementptr [8 x i8], [8 x i8]* @string.literal.JaNBvOiUcl, i32 0, i32 0
	%8 = getelementptr [3 x i8], [3 x i8]* @string.literal.FQyaAJTWgh, i32 0, i32 0
	...
	%17 = alloca i8*
	store i8* %16, i8** %17
	br label %for.declaration.pZwYCoMpbq

leave.taehqKeCeI:
	%18 = getelementptr [7 x i8], [7 x i8]* @string.literal.QGSJUuIsxu, i32 0, i32 0
...
for.declaration.pZwYCoMpbq:
	%24 = load i8*, i8** %17
	%25 = load %FILE*, %FILE** %10
	%26 = call i8* @fgets(i8* %24, i32 10, %FILE* %25)
	%27 = ptrtoint i8* %26 to i32
	%28 = icmp ne i32 %27, 0
	br i1 %28, label %for.block.cDQRvgPqLz, label %leave.taehqKeCeI

for.condition.DjgrNGubLr:
	%29 = load i8*, i8** %17
	%30 = load %FILE*, %FILE** %10
	%31 = call i8* @fgets(i8* %29, i32 10, %FILE* %30)
	%32 = ptrtoint i8* %31 to i32
	%33 = icmp ne i32 %32, 0
	br i1 %33, label %for.block.cDQRvgPqLz, label %leave.taehqKeCeI

for.block.cDQRvgPqLz:
	%34 = load i8*, i8** %17
	%35 = getelementptr [4 x i8], [4 x i8]* @"%s ", i32 0, i32 0
	%36 = call i32 (i8*, ...) @printf(i8* %35, i8* %34)
	br label %for.update.xDkkJDztIM

for.update.xDkkJDztIM:
	br label %for.condition.DjgrNGubLr
}

define ccc void @main() {
main:
	%0 = getelementptr [17 x i8], [17 x i8]* @string.literal.UVDgPnWDIg, i32 0, i32 0
